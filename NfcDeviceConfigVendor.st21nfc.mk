...
ifneq ($(strip $(TARGET_BUILD_VARIANT)),user)
   ...
   vendor/st/nfc/hardware/st/nfc/conf/libnfc-hal-st.conf.st21nfc:$(TARGET_COPY_OUT_VENDOR)/etc/libnfc-hal-st.conf:st
  ...
  # Configuration files for user build, remove some logs for GSMA certif
   ...
   vendor/st/nfc/hardware/st/nfc/conf/libnfc-hal-st.conf.st21nfc.user:$(TARGET_COPY_OUT_VENDOR)/etc/libnfc-hal-st.conf:st
