...
public final class StAidGroup implements Parcelable {
    ...
    public StAidGroup(List<String> aids, String category, String description) {
        if (DBG) Log.d(TAG,
                "constructor - category: " + category + ", description: " + description);
    ...
    static public StAidGroup createFromXml(XmlPullParser parser)
        ...
        if (DBG) Log.d(TAG,
                "createFromXml() - category: " + category + ", description: " + description);
        return group;
    }
