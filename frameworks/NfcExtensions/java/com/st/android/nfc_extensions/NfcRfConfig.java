 ...
 * proprietary APIs defined
 * in the {@link NfcAdapterStExtensions} class.<p>
 * It contains information about the RF configuration to be applied:
 * is the mode enabled or not, and if so, which technologies must be programmed.<p>
 * It also provides a set of method to to set or retrieve some information.
 */
