...
/**
 * These entries only represent the card emulation services declared by applications with at least one
 * AID group that belongs to the category CardEmulation.CATEGORY_OTHER. Only those specific groups can be
 * enabled or disabled. CATEGORY_PAYMENT groups are handled differently in Android (Tap&Pay).
 *
 * The content of this class must be considered as read-only from Settings application.
 */
public final class ServiceEntry implements Parcelable {
    ...
    public ServiceEntry(ComponentName component, String tag, String title, Integer banner, Boolean wasEnabled, Boolean wantEnabled) {
