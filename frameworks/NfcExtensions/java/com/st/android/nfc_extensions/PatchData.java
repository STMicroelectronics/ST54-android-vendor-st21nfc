...
public class PatchData {
     ...
     *             <p class="note"> In case the FW version is not patched, the array will contain
     *             only 0<p>
     *             and the {@link PatchData} object will be void.
     * @return
     */
    ...
    /**
     * Indicates if the FW patch currently used by the current ST21NFCB chip is a debug version
     * or not.
     *
