...
public final class StApduServiceInfo implements Parcelable {
    ...
    public StApduServiceInfo(
            ...
            boolean onHost,
            String description,
            ArrayList<StAidGroup> staticAidGroups,
            ArrayList<StAidGroup> dynamicAidGroups,
    ...
    public void updateServiceCommitStatus(String category, boolean commitStatus) {
        ...
        Log.d(TAG, "updateServiceCommitStatus(exit) - mServiceState: " + mServiceState);
    }
