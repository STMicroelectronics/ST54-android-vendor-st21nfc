 ...
 *
 * Derived from android.nfc.dta.NfcDta of /system/framework
...
public final class NfcAdapterDta {
    private static final String TAG = "NfcAdapterDta";

    private static INfcDta sService;
    private static HashMap<Context, NfcAdapterDta> sNfcDtas = new HashMap<Context, NfcAdapterDta>();

    private final Context mContext;

    private NfcAdapterDta(Context context, INfcDta service) {
     ...
     * @return
     */
    public static synchronized NfcAdapterDta getInstance(NfcAdapter adapter) {
        ...
        NfcAdapterDta manager = sNfcDtas.get(context);
        if (manager == null) {
            ...
            manager = new NfcAdapterDta(context, service);
